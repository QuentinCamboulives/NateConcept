...
$().ready(function(){
    ...
    if($('#twitter').length != 0){
        $('#twitter').sharrre({
          ...
          url: 'http://demos.creative-tim.com/paper-dashboard-pro/examples/dashboard/index.html'
        });
    }
...
demo = {
    ...
    initCirclePercentage: function(){
            ...
            $('#chartDashboard, #good-answer-percentage, #chartNewVisitors, #chartSubscriptions, #chartDashboardDoc, #chartOrdersDoc').easyPieChart({
        		lineWidth: 6,
        		size: 160,
        		scaleColor: false,
